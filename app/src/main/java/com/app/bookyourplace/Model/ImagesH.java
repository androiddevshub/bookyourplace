...
public class ImagesH implements Parcelable {
    ...
    public static final Creator<ImagesH> CREATOR = new Creator<ImagesH>() {
        @Override
        public ImagesH createFromParcel(Parcel source) {
            return new ImagesH(source);
        }

        @Override
        public ImagesH[] newArray(int size) {
            return new ImagesH[size];
        }
    };
}
